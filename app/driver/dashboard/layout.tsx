        ...
        <div className="food-app-shell min-h-screen text-white">
            <header className="food-app-nav sticky top-0 z-50 border-b border-white/10">
                ...
                <div className="mx-auto flex w-[min(1240px,calc(100%-24px))] gap-2 overflow-x-auto pb-3">
                    <Link href="/driver/dashboard" className="rounded-full border border-[#e8a230]/35 bg-[#e8a230]/10 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.12em] text-[#e8a230]">Dashboard</Link>
                    <Link href="/driver/dashboard/earnings" className="rounded-full border border-white/10 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.12em] text-white/70 hover:text-white">Settlements</Link>
                    <Link href="/driver/dashboard/ratings" className="rounded-full border border-white/10 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.12em] text-white/70 hover:text-white">Reputation</Link>
                    <Link href="/driver/dashboard/account" className="rounded-full border border-white/10 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.12em] text-white/70 hover:text-white">Profile</Link>
                </div>
            </header>
