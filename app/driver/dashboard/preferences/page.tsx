    ...
    return (
        <div className="font-sans">
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .toggle-sw.on { background: #f97316; }
                ...
                .nav-option.active { background: #1a1200; border-color: #f97316; color: #f97316; }
                        ...
                        <div style={{ padding: '12px 16px', borderBottom: '1px solid #131720' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px' }}>
                                <div className="nav-option active">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M7 2L9 6h3L9 9l1 4-3-2-3 2 1-4-3-3h3L7 2z" stroke="#f97316" strokeWidth="1.1"/></svg>
                                    Google Maps
                                </div>
