            ...
            <div className="adm-page-body">
                <div className="adm-card" style={{ marginBottom: 16 }}>
                    ...
                    <p style={{ color: '#888', fontSize: 13, lineHeight: 1.6, margin: 0 }}>
                        This is the support command center. It gives the team a quick snapshot of open chats and escalations, so you can review support conversations, jump in when a user needs a human, and close out resolved issues without digging through the inbox.
                    </p>
