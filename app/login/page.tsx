    ...
    return (
        <div className="login-grid font-sans">
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .bg-overlay { position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(12,14,19,0.2) 0%, rgba(12,14,19,0.9) 100%); z-index: 1; }
            ...
            <div className="left-panel">
                <img src="/driver_login_bg_car.png" alt="" className="bg-img" />
