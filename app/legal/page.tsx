        ...
        <div className="container py-20 max-w-4xl mx-auto space-y-12">
            ...
            <section id="terms" className="card p-8 bg-white/5 border border-white/10">
                ...
                <div className="prose prose-invert max-w-none text-sm text-slate-300 space-y-4">
                    ...
                    <p>All payments are processed securely via Stripe. In the event of a dispute or service failure during the pilot, please contact support@trueserve.com for a full refund.</p>
                </div>
            </section>
            ...
            <div className="text-center pt-8 border-t border-white/10">
                <p className="text-xs text-slate-500">
                    For questions, contact <a href="mailto:support@trueserve.com" className="text-primary hover:underline">support@trueserve.com</a>
                </p>
            </div>
        </div>
    );
