...
import { Camera, Home, MapPin, Moon, ShieldCheck, UtensilsCrossed } from "lucide-react";
// (Mail, Phone, UserRound removed — Apple OAuth dropped, input icons no longer used)
