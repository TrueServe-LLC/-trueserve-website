    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] text-[#F0EDE8] font-barlow overflow-x-hidden pb-32">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="orb w-[300px] h-[300px] top-[-100px] right-[-100px] bg-[#E8A020]/10" />
                <div className="orb w-[250px] h-[250px] top-[40%] left-[-80px] bg-[rgba(232,162,48,0.05)]" />
            </div>
            ...
            <nav className="sticky top-0 z-[60] bg-[#0A0A0A]/85 backdrop-blur-2xl border-b border-white/5 px-5 py-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="font-bebas text-2xl italic tracking-widest text-white uppercase">Mission Logs</h1>
                </div>
                <div className="w-10 h-10 rounded-full bg-[#141417] border border-white/5 flex items-center justify-center text-lg">🛰️</div>
            </nav>
