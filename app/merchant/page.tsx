                            ...
                            <div className="pt-4 border-t border-white/5">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <select name="state" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors appearance-none" required>
