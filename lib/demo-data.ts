...
export const MOUNT_AIRY_RESTAURANTS = [
    {
        ...
        plan: "Flex Scale",
        menuItems: [
            { name: "Buffalo Shrimp", description: "Lightly breaded and fried served with ranch or bleu cheese", price: 10.00, category: "Starters", status: 'APPROVED', imageUrl: "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?q=80&w=2940&auto=format&fit=crop" },
            { name: "13 Bones Burger", description: "10oz hamburger topped with crispy bacon, cheddar cheese", price: 14.00, category: "Sandwiches", status: 'APPROVED', imageUrl: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=2940&auto=format&fit=crop" },
            { name: "Baby Back Ribs (Full Slab)", description: "Our signature ribs basted in KC or Vinegar sauce", price: 26.00, category: "Entrees", status: 'APPROVED', imageUrl: "/thirteen_bones_ribs.png" }
        ],
        orders: [] // Blank per user request for demo
    },
    {
        name: "Snappy Lunch",
        ...
        plan: "Flex Scale",
        menuItems: [
            { name: "World-Famous Pork Chop Sandwich", description: "The legendary breaded pork chop sandwich.", price: 8.50, category: "Specials", status: 'APPROVED', imageUrl: "/snappy_pork_chop.png" },
            { name: "Breaded Cheeseburger", description: "Classic lunch counter cheeseburger.", price: 6.50, category: "Lunch", status: 'APPROVED', imageUrl: "https://images.unsplash.com/photo-1512152272829-e3139592d56f?q=80&w=2940&auto=format&fit=crop" }
        ],
        orders: []
    },
    {
        ...
        plan: "Pro Scale",
        menuItems: [
            { name: "ONS Board (Charcuterie)", description: "Three NC Cheeses, Prosciutto, Salami", price: 22.00, category: "Shares", status: 'APPROVED', imageUrl: "/old_north_state_charcuterie.png" },
            { name: "ONS Burger", description: "Winery signature burger with house toppings", price: 17.00, category: "Lunch", status: 'APPROVED', imageUrl: "https://images.unsplash.com/photo-1550547660-d9450f859349?q=80&w=2940&auto=format&fit=crop" }
        ],
        orders: []
    },
    {
    ...
    },
    {
        ...
        plan: "Flex Scale",
        menuItems: [
            { name: "Chopped BBQ Plate", description: "Served with two sides and hushpuppies.", price: 15.00, category: "Plates", status: 'APPROVED', imageUrl: "/littlerichards_bbq_plate.png" },
            { name: "LRB Jumbo Smoked Wings", description: "Slow-smoked wings with choice of sauce", price: 17.00, category: "Wings", status: 'APPROVED', imageUrl: "https://images.unsplash.com/photo-1527477396000-e27163b481c2?q=80&w=2940&auto=format&fit=crop" }
        ],
        orders: []
    },
    {
