...
.db { background:#0c0e13; font-family:'DM Sans',sans-serif; color:#fff; min-width:900px; min-height: 100vh; }
.db .nav { display:flex; align-items:center; justify-content:space-between; padding:0 24px; height:52px; background:#0c0e13; border-bottom:1px solid #1c1f28; }
...
.db .nav-link.alert { color:#e8a230; }
.db .nav-cta { background:#e8a230; color:#000; font-size:11px; font-weight:700; letter-spacing:0.08em; padding:7px 14px; text-transform:uppercase; cursor:pointer; text-decoration: none; border: none; display: inline-block; }
.db .nav-cta:hover { background: #f2ae3e; }

.db .infra-banner { background:#111420; border-bottom:2px solid #e8a230; padding:10px 24px; display:flex; align-items:center; justify-content:space-between; }
.db .infra-left .infra-title { font-size:18px; font-weight:700; font-style:italic; color:#fff; letter-spacing:0.02em; }
.db .infra-left .infra-title span { color:#e8a230; }
.db .infra-left .infra-sub { font-size:10px; font-weight:600; letter-spacing:0.14em; color:#e8a230; text-transform:uppercase; margin-top:2px; }
.db .infra-btn { background:transparent; border:1.5px solid #e8a230; color:#e8a230; font-size:11px; font-weight:700; letter-spacing:0.1em; padding:8px 18px; text-transform:uppercase; cursor:pointer; white-space:nowrap; }

.db .registry-header { padding:16px 24px 12px; border-bottom:1px solid #1c1f28; display:flex; align-items:center; justify-content:space-between; }
.db .registry-title { font-size:22px; font-weight:700; color:#fff; }
.db .registry-title span { color:#e8a230; }
.db .registry-sub { font-size:10px; font-weight:500; letter-spacing:0.16em; color:#444; text-transform:uppercase; margin-top:3px; }
.db .toggles-row { display:flex; align-items:center; gap:8px; }
.db .toggle-block { display:flex; align-items:center; gap:8px; background:#131720; border:1px solid #1c1f28; padding:7px 12px; }
...
.db .toggle-switch.on { background:#e8a230; }
...
.db .stats-section-label { font-size:10px; font-weight:600; letter-spacing:0.14em; color:#555; text-transform:uppercase; margin-bottom:10px; display:flex; align-items:center; justify-content:space-between; }
.db .stats-time-tabs { display:flex; gap:2px; }
.db .time-tab { font-size:10px; font-weight:600; letter-spacing:0.08em; color:#555; padding:4px 10px; background:#131720; border:1px solid #1c1f28; cursor:pointer; text-transform:uppercase; border: none; }
.db .time-tab.active { background:#e8a230; color:#000; border-color:#e8a230; }
...
.db .stats-grid { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:1px; background:#1c1f28; border:1px solid #1c1f28; }
...
.db .stat-value { font-size:28px; font-weight:700; color:#fff; line-height:1; font-family:'DM Mono',monospace; letter-spacing:-0.02em; }
.db .stat-desc { font-size:10px; color:#444; text-transform:uppercase; letter-spacing:0.08em; margin-top:5px; }

.db .section-divider { height:1px; background:#1c1f28; margin:0 24px; }
.db .scenario-section { padding:16px 24px; }
.db .scenario-header { display:flex; align-items:baseline; gap:12px; margin-bottom:4px; }
.db .scenario-title { font-size:20px; font-weight:700; font-style:italic; color:#fff; }
.db .scenario-title span { color:#e8a230; }
...
.db .alert-dot { width:6px; height:6px; background:#e8a230; border-radius:50%; flex-shrink:0; }
.db .alert-text { font-size:10px; font-weight:600; letter-spacing:0.1em; color:#e8a230; text-transform:uppercase; }
.db .scenario-grid { display:grid; grid-template-columns:1fr 1fr 1fr; gap:1px; background:#1c1f28; border:1px solid #1c1f28; }
...
.db .bev-label { font-size:10px; font-weight:600; letter-spacing:0.16em; color:#e8a230; text-transform:uppercase; margin-bottom:12px; }
.db .bev-number { font-size:72px; font-weight:700; color:#fff; font-family:'DM Mono',monospace; line-height:1; margin-bottom:8px; }
...
.db .scaling-pct { font-size:11px; font-weight:700; color:#e8a230; }
.db .progress-bar-bg { height:4px; background:#1c1f28; margin-bottom:16px; }
.db .progress-bar-fill { height:100%; background:#e8a230; width:27.4%; }
...
.db .profit-value { font-size:30px; font-weight:700; color:#e24b4a; font-family:'DM Mono',monospace; }
...
.db .bench-section { padding:0 24px 24px; }
.db .bench-header { display:flex; align-items:baseline; justify-content:space-between; margin-bottom:12px; }
...
.db .bench-table { width:100%; border-collapse:collapse; border:1px solid #1c1f28; }
...
.db .bench-table th.gold { color:#e8a230; }
...
.db .bench-table td.ts { color:#e8a230; font-weight:600; }
.db .bench-table tr:last-child td { border-bottom:none; }
.db .bench-insight { background:#0f1219; border:1px solid #1c1f28; border-left:3px solid #e8a230; padding:14px 16px; margin-top:12px; }
