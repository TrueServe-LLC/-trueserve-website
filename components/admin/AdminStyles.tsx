...
.db .infra-banner { background:#111420; border-bottom:2px solid #e8a230; padding:16px; display:flex; flex-direction: column; align-items: flex-start; gap: 16px; }
...
.db .infra-btn { background:transparent; border:1.5px solid #e8a230; color:#e8a230; font-size:11px; font-weight:700; letter-spacing:0.1em; padding:8px 18px; text-transform:uppercase; cursor:pointer; white-space:nowrap; width: 100%; }
@media (min-width: 768px) {
