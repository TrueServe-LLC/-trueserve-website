        ...
        return (
            <div className="md:hidden fixed bottom-4 left-4 right-4 z-[100]">
                <nav className="bg-black/80 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-3 flex justify-around items-center text-[10px] font-bold uppercase tracking-wider text-slate-500">
                    ...
                    <Link href="/merchant/dashboard" className={`flex flex-col items-center gap-1 flex-1 transition-all ${isActive('/merchant/settings') ? 'text-primary' : 'active:scale-95'}`}>
    ...
    return (
        <div className="md:hidden fixed bottom-4 left-4 right-4 z-[100]">
            <nav className="bg-black/80 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-3 flex justify-around items-center text-[10px] font-bold uppercase tracking-wider text-slate-500">
                ...
                <Link
                    href="/user/settings"
                    className={`flex flex-col items-center gap-1 flex-1 transition-all ${isActive('/user') || isActive('/login') ? 'text-primary scale-110' : 'active:scale-95'}`}
                >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    <span>Profile</span>
                </Link>
